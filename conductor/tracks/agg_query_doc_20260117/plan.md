...
- [x] Task: Draft English Content
    - [x] Draft the "Aggregation Queries" section for `README.md`.
    - [x] Include examples for count, sum, avg, group by, and mapping.
- [x] Task: Draft Chinese Content
    - [x] Translate the drafted section for `README_CN.md`.
